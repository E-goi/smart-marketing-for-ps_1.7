...
<div class="panel">
    ...
    <form method="post">
        <table class="table" id="egoi-subs-table">
            ...
            <tr valign="top">
                <th class="egoi-td" scope="row" style="padding-bottom: 25px;">{l s='Back in stock' mod='smartmarketingps'}</th>
                <td>
                    <div id="egoi_back_in_stock_warning" style="display: none; color: #ca5c54; font-weight: bold; background: #ffe4e4; padding: 8px 12px; border-radius: 4px; margin-top: 0; width: fit-content;">
                        {l s='This configuration is already active for another domain' mod='smartmarketingps'}
                    </div>
                    <div style="display: flex; align-items: center; gap: 10px;">
                        <span class="switch prestashop-switch fixed-width-lg" id="egoi_back_in_stock_toggle_wrapper" style="display: none;">
                            <input type="radio" name="egoi_back_in_stock_toggle" id="egoi_back_in_stock_toggle_on" value="0">
                            <label for="egoi_back_in_stock_toggle_on">{l s='Active' mod='smartmarketingps'}</label>
                            <input type="radio" name="egoi_back_in_stock_toggle" id="egoi_back_in_stock_toggle_off" value="1" checked="checked">
                            <label for="egoi_back_in_stock_toggle_off">{l s='Disabled' mod='smartmarketingps'}</label>
                            <a class="slide-button btn"></a>
                        </span>
                        <i class="icon-spinner icon-spin" id="egoi_back_in_stock_loading"></i>
                    </div>
                    <p class="help" id="egoi_back_in_stock_help" style="display: none; margin-top: 10px;">{l s='Enable to track back in stock and trigger your automated journey in E-goi.' mod='smartmarketingps'}</p>
                </td>
            </tr>
            <tr valign="top">
        ...
        <table class="table">
            ...
            <tr style="display:none;">
                <td colspan="2" style="text-align: right;">
                    ...
                    <input type="hidden" name="egoi_back_in_stock_toggle_hidden" id="egoi_back_in_stock_toggle_hidden" value="1">
