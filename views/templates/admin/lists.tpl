    ...
    {if $lists}
        <table class="table">
            ...
            {foreach $lists as $key => $list}
                <tr>
                    <td width="60">{$list.listnum|escape:'htmlall':'UTF-8'}</td>
                    <td width="250">{$list.title|escape:'htmlall':'UTF-8'}</td>
                    <td width="250">{$list.title_ref|escape:'htmlall':'UTF-8'}</td>
                    <td width="100">{$list.subs_activos|escape:'htmlall':'UTF-8'}</td>
                    <td width="100">{$list.subs_total|escape:'htmlall':'UTF-8'}</td>
                    <td width="100">{$list.idioma|escape:'htmlall':'UTF-8'}</td>
                    <td width="100">
