...
$updateql[_DB_PREFIX_.'egoi_active_catalogs_306_3'] = 'ALTER TABLE `'._DB_PREFIX_.'egoi_active_catalogs` ADD `sync_stock` int(1) NOT NULL DEFAULT \'1\';';
$updateql[_DB_PREFIX_.'egoi_active_catalogs_306_3'] = 'ALTER TABLE `'._DB_PREFIX_.'egoi_active_catalogs` ADD `sync_variations` int(1) NOT NULL DEFAULT \'1\';';
$updateql[_DB_PREFIX_.'egoi_active_catalogs_306_4'] = 'UPDATE `'._DB_PREFIX_.'tab` SET `icon`=\'settings\' where `module`=\'smartmarketingps\' AND `class_name`=\'Account\';';
